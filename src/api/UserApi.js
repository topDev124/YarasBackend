...
router.post('/invoice/getDeleted', InvoiceManagement.getAllDeleted)
...
router.post('/invoice/searchDeleted', InvoiceManagement.searchFilterDeletedInvoice)
...
router.post('/invoice/history/create', History.createHistory)
router.post('/invoice/history/getAll', History.getAll)
